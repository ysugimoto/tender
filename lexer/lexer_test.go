...
`
	expects := []token.Token{
		...
		{Type: token.TILDA, Literal: "~", Line: 3, Position: 23},
		...
		{Type: token.FOR, Literal: "for", Line: 7, Position: 4},
		{Type: token.IDENT, Literal: "i", Line: 7, Position: 8},
		{Type: token.COMMA, Literal: ",", Line: 7, Position: 9},
		{Type: token.IDENT, Literal: "v", Line: 7, Position: 11},
		{Type: token.IN, Literal: "in", Line: 7, Position: 13},
		{Type: token.IDENT, Literal: "some_map", Line: 7, Position: 16},
		{Type: token.LITERAL, Literal: "\nAlso can loop for map.\n", Line: 7, Position: 26},
